...
public class Magpie4
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword("I", statement, 0) >= 0 && findKeyword("you", statement, 0) >=0) {
	...
	private String getRandomResponse()
	{
		...
		String response = "";
		String randomResponses[] = {"You don't say.", "Do you really think so?", "Hmmm.", "Interesting, tell me more."};
